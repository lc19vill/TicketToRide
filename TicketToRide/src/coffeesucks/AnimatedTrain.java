...
public class AnimatedTrain extends GameObject {
    ...
    public AnimatedTrain(int player, int ID) {
        ...
        if (player == 2) {
            path = (dir + "\\TTRAssets\\trainanimations\\player2\\1_" + ID + ".gif");
        }
        if (player == 3) {
            path = (dir + "\\TTRAssets\\trainanimations\\player3\\1_" + ID + ".gif");
        }
        if (player == 4) {
            path = (dir + "\\TTRAssets\\trainanimations\\player4\\1_" + ID + ".gif");
        }
        if (player == 5) {
            path = (dir + "\\TTRAssets\\trainanimations\\player5\\1_" + ID + ".gif");
        }
